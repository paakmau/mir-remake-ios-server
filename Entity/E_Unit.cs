...
namespace MirRemakeBackend.Entity {
    ...
    class E_Character : E_Unit {
        ...
        public NO_SightCharacter GetSightNo (bool isMarket, short attachedTitleMisId) {
            return new NO_SightCharacter (m_networkId, m_characterId, m_position, m_Occupation, m_name, m_Level, isMarket, attachedTitleMisId);
        }
